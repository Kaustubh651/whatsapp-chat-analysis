...
if uploaded_file is not None:
    ...
    if st.sidebar.button('Show Analysis'):
        ...
        ax.plot(timeline['time'],timeline['message'],color='#FF4B4B')
        ...
        fig,ax = plt.subplots()
        ax.plot(daily_timeline['only_date'],daily_timeline['message'],color='#ff4b4b')
        plt.xticks(rotation='vertical')
        ...
        fig,ax=plt.subplots()
        ax.barh(most_common_df[0],most_common_df[1],color='#FF4B4B')
        plt.xticks(rotation='vertical')
